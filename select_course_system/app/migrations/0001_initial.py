# -*- coding: utf-8 -*-
# Generated by Django 1.11.7 on 2019-02-20 06:21
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('name', models.CharField(max_length=10, primary_key=True, serialize=False)),
                ('num', models.IntegerField(default=0)),
                ('ins', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='app.Institute')),
            ],
        ),
        migrations.CreateModel(
            name='Stu_cou',
            fields=[
                ...
                ('cou', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='app.Courses')),
            ],
        ),
        migrations.CreateModel(
            name='Student',
            fields=[
                ...
                ('cclass', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='app.Class')),
            ],
        ),
        migrations.CreateModel(
            name='Teacher',
        ...
        migrations.AddField(
            model_name='class',
            name='special',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='app.Special'),
        ),
    ]
