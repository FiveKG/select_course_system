...
class Captcha(object):
    ...
    def initialize(self, width=200, height=75, color=None, text=None, fonts=None):
        ...
        self.fonts = fonts if fonts else \
            [os.path.join(r'F:\Pycharm\select_course_system\static\fonts', font) for font in ['Arial.ttf', 'Georgia.ttf', 'actionj.ttf']]
        # in ubuntu
        # self.fonts = fonts if fonts else \
        #     [os.path.join(r'/usr/share/fonts/truetype', font) for font in ['Arial.ttf', 'Georgia.ttf', 'actionj.ttf']]
        self.width = width
        self.height = height
